...
class Request {
  static Dio getDio() {
    ...
    dio.options.headers = {
      ...
      'api_key': "quHMRDXrb5M1qIPJC2SVSmX8X9HdwcLaXlQaHZEe5FjSrapNgCvNKbTjyXEmNsWaAmMla14t84NSCI3a4UTtbHfAFPnEw75iNgY8KHp4Q8kIkeiak4u1WtirWpvY5UrZ",
      'token': Global.Token
    };
    ...
    return Scaffold(
      ...
      appBar: Global.index == 0
          ...
          : AppBar(
              ...
              elevation: 0.0,
              title: Global.index != 4? Transform.translate(
              ...
              leading: Global.index == 4
                  ? BadgeIconButton(
                      itemCount: unread_number, // required
                      icon: Icon(
                        GIcons.mail,
                        color: Colors.grey,
                        size: 32.0,
