          ...
          ? Container(
              child: widget.iconList.length == 0
                  ...
                  : GestureDetector(
                      ...
                      child: Image.network(
                        Global.baseUrl + widget.iconList[0],
                        fit: BoxFit.cover,
                      ),
                    ),
            )
...
class Create_DatePickerState extends State<Create_DatePicker> {
  ...
  void _showDatePicker() async{
    // _selectDate(context);
    DateTime now = new DateTime.now();
    var  time = await showDatePicker(context: context,
    firstDate: DateTime.parse("1-1-1970"),
    lastDate: DateTime.parse("1-1-1970"),
  ...
  setValue(time.year, time.month, time.day);
...
class _Create_Google_Map_PickerState extends State<Create_Google_Map_Picker> {
  ...
  showPlacePicker() async {
    try {
      ...
      if (place != null) {
        setState(() {
          setValue(place.formattedAddress, place.latLng.longitude, place.latLng.latitude);
        });
      }
    } catch (e) {}
  }
