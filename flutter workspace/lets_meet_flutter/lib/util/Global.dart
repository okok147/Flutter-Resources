...
class Global {
  ...
  static GlobalKey <EventPageState> keyContentSection = new GlobalKey<EventPageState>(); 
  ...
  static
  const TextStyle stlye_title = TextStyle(
    color: Colors.white,
    fontSize: 14.0,
  ...
  static const TextStyle stlye_subTitle_time = TextStyle(
   ...
   static const
   TextStyle stlye_title_not_approve = TextStyle(
  ...
  static
  const TextStyle style_hubText = TextStyle(
  ...
  static
  const TextStyle style_hubDetail = TextStyle(
    color: Color.fromRGBO(96, 96, 96, 1.0),
    fontSize: 12.0,
    height: 1.2,    
    fontFamily: "HelveticaNeue",    
  ...
  static
  const TextStyle stlye_sliderTitle = TextStyle(
    color: Color(0xFFA1A1A1),
    fontSize: 13.0,
    fontFamily: "HelveticaNeue"
  );

  static const TextStyle style_bottomBarActive = TextStyle(color:Color(0xFF4F5A9C), fontSize: 9.0 );
  static const TextStyle style_bottomBar = TextStyle(fontSize: 9.0 );

  static
  const TextStyle style_input = TextStyle(
    color: Colors.white,
    fontSize: 17.0,
    height: 0.8,
    fontFamily: "HelveticaNeue"
  ...
  static
  const TextStyle style_profile_title = TextStyle(
  ...
  static
  const TextStyle style_profile = TextStyle(
    color: Color(0xFF7D7C7C),
    // color: Colors.red,
    height: 1.2,
    fontSize: 15.0,
...
Future<LocationResult> showRealPlacePicker(BuildContext context) async {
    LocationResult result = await Navigator.of(context).push(MaterialPageRoute(
        builder: (context) =>
            PlacePicker("AIzaSyCxY_4FhiERwXTmU6SGgunoYg5djvFG9RM")));
