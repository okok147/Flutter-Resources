...
class Question5Widget extends StatelessWidget {
  
  void onLeftArrowPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => Question4Widget()));
  
  void onViewPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => HelloWidget()));
                              ...
                              children: [
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    height: 428,
                                    child: Image.asset(
                                      "assets/images/asset-23x-8-2.png",
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            "You come home and everything is as it left?",
                                            style: TextStyle(
                                              color: Color.fromARGB(255, 255, 255, 255),
                                              fontSize: 16,
                                              fontFamily: "",
