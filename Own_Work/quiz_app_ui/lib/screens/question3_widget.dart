...
import 'package:quiz_app_ui/screens/question4_widget.dart';


class Question3Widget extends StatelessWidget {
  
  void onLeftArrowPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => Question2Widget()));
  
  void onViewPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => Question4Widget()));
                              ...
                              children: [
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    height: 428,
                                    child: Image.asset(
                                      "assets/images/asset-23x-8-4.png",
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            "Can your slipper be thrown a million yards away without missing a target?",
                                            style: TextStyle(
                                              color: Color.fromARGB(255, 255, 255, 255),
                                              fontSize: 16,
                                              fontFamily: "",
